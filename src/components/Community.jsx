              ...
              <div>
                ...
                {notices.length > 0 ? (
                  notices.map((notice, index) => (
                    <div key={notice.id} className="contents-upload">
                      <p>{index + 1}</p>
                      <p className="basis-title">{notice.title}</p>
                      <p className="author">{notice.author}</p>
                      <p className="date">{new Date(notice.created_at).toLocaleDateString()}</p>
                      <p className="views">{notice.views}</p>
                    </div>
                  ))
                ) : (
