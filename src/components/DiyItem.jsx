...
const DiyItem = () => {
  ...
  useEffect(() => {
    axios.get(`https://whippedback.9seebird.site/get_product`).then((response) => {
    ...
    if (existingItem) {
      ...
      if (shouldUpdate) {
        try {
          ...
          await axios.post(
            `https://whippedback.9seebird.site/update_diy_quantity/${userId}`,
            {
      ...
      try {
        await axios.post(`https://whippedback.9seebird.site/add_Diyitem/${userId}`, cartItem, {
          headers: { 'Content-Type': 'application/json' },
        });
        alert('장바구니에 추가되었습니다!');
        ...
        <div className="detailArea">
          ...
          <div className="detailRight">
            <div className="detailInfo">
              <h2 className="productName">{diyItem[0] ? diyItem[0].p_name : ''}</h2>
              ...
              <div className="total">
                ...
                <div className="totalPrice">
                  <p>{diyItem[0] ? diyItem[0].p_price : ''}원</p>
                </div>
              </div>
